 ...
 */
class Language extends \Quiz\QzBundle\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Quiz\\QzBundle\\Entity\\Language' . "\0" . 'id', '' . "\0" . 'Quiz\\QzBundle\\Entity\\Language' . "\0" . 'name', '' . "\0" . 'Quiz\\QzBundle\\Entity\\Language' . "\0" . 'isoCode');
        }
