 ...
 */
class Caller extends \Quiz\QzBundle\Entity\Caller implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Quiz\\QzBundle\\Entity\\Caller' . "\0" . 'id', '' . "\0" . 'Quiz\\QzBundle\\Entity\\Caller' . "\0" . 'name', '' . "\0" . 'Quiz\\QzBundle\\Entity\\Caller' . "\0" . 'adress', '' . "\0" . 'Quiz\\QzBundle\\Entity\\Caller' . "\0" . 'phone', '' . "\0" . 'Quiz\\QzBundle\\Entity\\Caller' . "\0" . 'mail');
        }
